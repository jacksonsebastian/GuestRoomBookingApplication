      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="row mb-3">
          ...
          <div className="col-md-6 text-start">
            ...
            <input
              type="number"
              className={`form-control ${errors.floorSize ? "is-invalid" : ""}`}
              {...register("floorSize")}
            />
            <div className="invalid-feedback">{errors.floorSize?.message}</div>
          </div>
        </div>
        <div className="row mb-3">
          <div className="col-md-6 text-start">
        ...
        <div className="row mb-3">
          ...
          <div className="col-md-6 text-start">
            ...
            <input
              ...
              {...register("rentAmount")}
            />
            <div className="invalid-feedback">{errors.rentAmount?.message}</div>
          </div>
        </div>
        <div className="row mb-3">
